  ...
  (setq-default
   ...
   '(
     ...
     (dart :variables
      ...
      dart-server-sdk-path "~/misc/flutter/bin/cache/dart-sdk/")
...
Interactively also sends a terminating newline."
  ...
  ;;         (make-directory dir)))))
    ...
    (setq helm-ag-base-command "rg --vimgrep --no-heading --smart-case --line-number --no-column")
