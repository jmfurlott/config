...
;;
(def-doom-theme doom-hc-zenburn
  "An implementation of the popular Zenburn theme."

  ;; name        default   256       16
  ((bg         '("#313131" nil       nil            )) ;; zenburn-bg
   (bg-alt     '("#2D2D2D" nil       nil            )) ;; zenburn-bg-05
   (base0      '("#000000" "black"   "black"        )) ;; zenburn-bg-2
   (base1      '("#202020" "#1e1e1e" "brightblack"  )) ;; zenburn-bg-1
   (base2      '("#303030" "#2e2e2e" "brightblack"  )) ;; zenburn-bg-08
   (base3      '("#2D2D2D" "#262626" "brightblack"  )) ;; zenburn-bg-05
   (base4      '("#383838" "#3f3f3f" "brightblack"  )) ;; zenburn-bg+05
   (base5      '("#3E3E3E" "#525252" "brightblack"  )) ;; zenburn-bg+1
   (base6      '("#4E4E4E" "#6b6b6b" "brightblack"  )) ;; zenburn-bg+2
   (base7      '("#5E5E5E" "#979797" "brightblack"  )) ;; zenburn-bg+3
